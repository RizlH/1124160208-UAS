...
// Database kode promo
const promoCodes = {
    'SPA555': { discount: 5, type:'percentage', description: 'Diskon 5%'},
    'RZLH50': { discount: 50, type:'percentage', description: 'Diskon 50%'},
    'SV200K': { discount: 200000, type:'fixed', description: 'Diskon Rp 200.000'},
    'NEWUSR': { discount: 100000, type:'fixed', description: 'Diskon Rp 100.000'},
    'NWYEAR': { discount: 50000, type:'fixed', description: 'Diskon Rp 50.000'},
}
...
function setupEventListeners() {
    ...
    promoCode.addEventListener('keypress', handlePromoKeypress);
